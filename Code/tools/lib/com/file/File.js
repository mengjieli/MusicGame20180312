...
global.__define(File.prototype, "changeTime",
    function () {
        var str = (new Date(this.state.ctime.getTime())).toString();
        str = lib.StringDo.deleteChinese(str);
        return str;
    },
    function (val) {
    }
...
global.__define(File.prototype, "modifyTime",
    function () {
        var str = (new Date(this.state.mtime.getTime())).toString();
        str = lib.StringDo.deleteChinese(str);
        return str;
    },
    function (val) {
...
global.__define(File.prototype, "createTime",
    function () {
        var str = (new Date(this.state.birthtime.getTime())).toString();
        str = lib.StringDo.deleteChinese(str);
        return str;
    },
    function (val) {
...
global.lib.FileFormat = FileFormat;
global.lib.File = File;