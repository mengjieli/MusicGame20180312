...
var WebSocketServer = (function () {
    ...
    function WebSocketServer(clientClass, big) {
        ...
        this.big = big;
        this.clientClass = clientClass || lib.WebSocketServerClient;
        this.server = null;
        this.clients = [];
    }
    ...
    p.onConnectClient = function (request) {
        var connection = request.accept(null, request.origin);
        var client = new this.clientClass(connection, this.big);
        client.addEventListener(lib.Event.CLOSE, this.onCloseClient, this);
        this.clients.push(client);
        return client;
    }

    p.onCloseClient = function (event) {
...
global.lib.WebSocketServer = WebSocketServer;
