...
var HttpRequest = (function (_super) {
    ...
    p.onData = function (data) {
        ...
        this.dispatchEvent(new lib.Event(lib.Event.DATA));
    }

    p.onComplete = function () {
        this.dispatchEvent(new lib.Event(lib.Event.COMPLETE));
    }
...
global.lib.HttpRequest = HttpRequest;